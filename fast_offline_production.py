...
def main(args):
    ...
    OUTPUT_PATH = '/Users/tristan/epic/hgcroc/h2g_decode/output'
    ...
    if not args.skip_decode:
        ...
        subprocess.run(command, env=environment, cwd=H2GDECODE_PATH)
    ...
    os.system(f'mv output/*.pdf {WORKING_DIRECTORY}/run{run_number}')
